    ...
    <div className="bg-[#111111] py-5 px-2 2xl:px-0">
      <div className="max-w-[1600px] mx-auto">
        <div className="border border-[#B118BF] rounded-2xl shadow shadow-[#B118BF] py-4 lg:py-10 px-6 lg:px-[60px]">
          <h4 className="text-lg md:text-xl lg:text-2xl text-primary-foreground font-parkinsans font-semibold">
            Leave a comment
          </h4>
          {/*  */}
          <div className="flex items-center flex-col md:flex-row gap-5 lg:gap-16">
            <div className="w-full md:w-[50%] space-y-3 mt-5">
              <h5 className="text-base md:text-lg lg:text-xl text-primary-foreground font-parkinsans font-semibold">
                Name
              </h5>
              <input
                type="text"
                placeholder="Mr. Mubin Hossain"
                className="py-3 px-5 rounded-xl border min-w-full text-primary-foreground"
              />
            </div>
            <div className="w-full md:w-[50%] space-y-3 mt-5">
              <h5 className="text-base md:text-lg lg:text-xl text-primary-foreground font-parkinsans font-semibold">
        ...
        <div className="border rounded-2xl py-4 lg:py-10 px-6 lg:px-[60px] grid grid-cols-1 lg:grid-cols-2 gap-20 mt-20">
          <div className="space-y-3">
            ...
            <p className="text-xs md:text-sm lg:text-base text-[#959595] font-parkinsans font-semibold">
