  ...
  return (
    <div className="bg-[#111111]">
      <div className="py-16 max-w-[1600px] mx-auto">
        <div className="py-14 px-10  rounded-3xl max-w-[1120px] mx-auto mt-10" style={{
    background: "linear-gradient(90deg, #EC20FF 0%, rgba(118, 31, 143, 0.90) 24%, rgba(251, 245, 251, 0.40) 100%)",
  }}>
