          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <p className="text-sm md:text-base lg:text-lg text-primary-foreground font-normal font-parkinsans mt-4">
                TasteHub implemented AI-powered process automation for a global
                manufacturing client, enabling them to automate 65% of their
                manual operations and increase production efficiency by 42%. The
                result? A faster, more intelligent, and cost-effective business
                model.
              </p>
            </div>
