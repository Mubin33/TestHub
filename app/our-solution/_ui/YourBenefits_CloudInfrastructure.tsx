...
export default function YourBenefits_CloudInfrastructure() {
  return (
    <div
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="max-w-[1080px] mx-auto space-y-10 mt-10">
          ...
          <div className="flex items-center justify-end gap-3 lg:gap-10">
            <Image
              src="/monitor-unscreen.gif"
              alt="monitor-unscreen Icon"
              width={55}
              height={65}
            />
            <div
            ...
            >
              99.99% Uptime with global redundancy and monitoring.
            </div>
          </div>
          {/*  */}
          <div className="flex items-center justify-start gap-3 lg:gap-10">
            ...
            >
              Up to 50% Faster Deployments through automated provisioning.
            </div>
            <Image
              src="/launch-unscreen.gif"
              alt="launch-unscreen Icon"
              width={55}
              height={65}
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-3 lg:gap-10">
            <Image
              src="/global-solution-unscreen.gif"
              alt="global-solution-unscreen Icon"
              width={55}
              height={65}
            />
            <div
            ...
            >
              Seamless Scalability across global data regions.
            </div>
          </div>
          {/*  */}
          <div className="flex items-center justify-start gap-3 lg:gap-10">
            ...
            >
              40% Reduction in Cloud Costs via optimization frameworks.
            </div>
            <Image
              src="/reduce-cost-unscreen.gif"
              alt="reduce-cost-unscreen Icon"
              width={55}
              height={65}
            />
          </div>
