          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <p className="text-sm md:text-base lg:text-lg text-primary-foreground font-normal font-parkinsans mt-4">
                A leading logistics enterprise partnered with TasteHub
                ITelligence to modernize its on-prem infrastructure. Our team
                designed a multi cloud environment leveraging AWS and Azure,
                automating DevOps pipelines for continuous delivery and
                achieving zero downtime during migration. The result — faster
                deployment, enhanced security, and operational cost savings of
                35%.{" "}
              </p>
            </div>
