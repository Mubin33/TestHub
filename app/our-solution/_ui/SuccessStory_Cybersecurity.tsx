          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <p className="text-sm md:text-base lg:text-lg text-primary-foreground font-normal font-parkinsans mt-4">
                A leading European fintech enterprise partnered with TasteHub
                ITelligence to deploy a Zero-Trust Security Architecture across
                its hybrid infrastructure. The solution powered by AI driven
                monitoring and automated threat response reduced incident
                detection time by 78% and achieved ISO 27001 certification
                within six months.
              </p>
            </div>
